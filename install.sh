...
mkdir -p "$HOME/.config"/{fish,ghostty/themes,nvim}
...
ln -sf "$PWD/edit_fzf_grep.sh" "$HOME/.local/bin/edit_fzf_grep"
ln -sf "$PWD/edit_fzf_file.sh" "$HOME/.local/bin/edit_fzf_file"
